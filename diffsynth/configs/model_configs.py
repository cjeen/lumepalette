...
flux2_series = [
    ...
    {
        # Klein 9B transformer safetensors (local copy hash)
        "model_hash": "af49868c902754d6d21f0d7bd232b0bb",
        "model_name": "flux2_dit",
        "model_class": "diffsynth.models.flux2_dit.Flux2DiT",
        "extra_kwargs": {"guidance_embeds": False, "joint_attention_dim": 12288, "num_attention_heads": 32, "num_layers": 8, "num_single_layers": 24},
        "state_dict_converter": "diffsynth.utils.state_dict_converters.flux2_comfy_to_diffusers_klein.Flux2ComfyKleinToDiffusers",
    },
]
